...
def mydata(n, order, xrange):
    ...
    #xtemp, y, y1 = create_data().

    #convert xtemp to feature matrix of x accoridng 
    #to what is said above.

    # first convert xtemp to a data frame with one column
    # you can insert column "0" as 1.
    # then insert starting 2nd column, until order
